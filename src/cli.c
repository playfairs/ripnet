...
{
    printf("ripnet - network diagnostics and analysis "
           "toolkit\n\n");
    printf("Usage:\n");
    ...
    printf("  ripnet --scan HOST --start-port PORT "
           "--end-port PORT\n\n");
...
{
    printf("RIPNET(1)                 User Commands        "
           "        RIPNET(1)\n\n");
    printf("NAME\n");
    printf("  ripnet - advanced network diagnostics, "
           "security, and analysis toolkit\n\n");
    printf("SYNOPSIS\n");
    printf("  ripnet [OPTIONS]\n\n");
    printf("DESCRIPTION\n");
    printf("  ripnet provides interface inspection, packet "
           "capture, DNS tools,\n");
    printf("  tracing, ping, scanning, route and firewall "
           "helpers, bandwidth\n");
    printf("  monitoring, discovery, and authorized "
           "security checks from one CLI.\n\n");
    printf("OPTIONS\n");
    printf("  Interface Discovery:\n");
    printf("  -l, --list-interfaces          List all "
           "network interfaces\n");
    printf("  -s, --show-stats IFACE         Show "
           "statistics for interface\n\n");
    printf("  Packet Capture:\n");
    printf("  -c, --capture IFACE            Start packet "
           "capture on interface\n");
    printf("  -f, --filter FILTER            BPF filter "
           "expression\n");
    printf("  -n, --count N                  Capture N "
           "packets then exit\n");
    printf("  -p, --promisc                  Enable "
           "promiscuous mode\n\n");
    printf("  Load Testing:\n");
    printf("  -t, --tcp-stress HOST          Run TCP "
           "stress test\n");
    printf("  -h, --http-stress HOST         Run HTTP "
           "stress test\n");
    printf(
        "  -P, --port PORT                Target port\n");
    printf("  -C, --concurrency N            Number of "
           "concurrent connections\n");
    printf(
        "  -D, --duration SECONDS         Test duration\n");
    printf("  -R, --rate-limit N             Rate limit "
           "(connections/sec)\n");
    printf("  -H, --http-path PATH           HTTP path for "
           "stress test\n\n");
    printf("  DNS Tools:\n");
    printf("  -d, --dns-lookup HOST          DNS lookup\n");
    printf("  -r, --dns-reverse IP           Reverse DNS "
           "lookup\n");
    printf("  -q, --dns-query HOST TYPE     DNS query (A, "
           "AAAA, MX, etc.)\n");
    printf("  -Z, --dns-server SERVER        DNS server "
           "for queries\n");
    printf("  -Y, --dns-trace HOST           DNS trace\n");
    printf("  -Q, --dns-cache-flush          Flush DNS "
           "cache\n\n");
    printf("  Network Tracing:\n");
    printf("  -g, --traceroute HOST          Traceroute to "
           "host\n");
    printf(
        "  -G, --traceroute-tcp HOST     TCP traceroute\n");
    printf("  -U, --traceroute-udp HOST     UDP "
           "traceroute\n\n");
    printf("  Ping Tools:\n");
    printf("  -i, --ping HOST                Ping host\n");
    printf("  -J, --ping-tcp HOST:PORT       TCP ping\n");
    printf("  -K, --ping-count N             Number of "
           "pings\n\n");
    printf("  Scanning:\n");
    printf("  -M, --scan HOST                Port scan\n");
    printf(
        "  -O, --service-scan HOST:PORT   Service scan\n");
    printf("  -B, --os-fingerprint HOST       OS "
           "fingerprinting\n");
    printf("  -a, --start-port PORT         Start port for "
           "scan\n");
    printf("  -e, --end-port PORT           End port for "
           "scan\n");
    printf("  -T, --timeout MS               Connection "
           "timeout\n\n");
    printf("  Network Statistics:\n");
    printf("  -E, --netstat                  Show network "
           "connections\n");
    printf("  -L, --netstat-listening        Show "
           "listening ports\n");
    printf("  -W, --netstat-route            Show routing "
           "table\n\n");
    printf("  ARP Tools:\n");
    printf("  -A, --arp-table                Show ARP "
           "table\n");
    printf("  -y, --arp-scan NETWORK         ARP scan "
           "network\n");
    printf("  -z, --arp-flush IFACE          Flush ARP "
           "cache\n\n");
    printf("  Routing:\n");
    printf("  -o, --route-table              Show routing "
           "table\n");
    printf("  -1, --route-add DEST           Add route\n");
    printf(
        "  -2, --route-delete DEST        Delete route\n");
    printf("  -3, --gateway GATEWAY          Gateway for "
           "route\n");
    printf("  -4, --netmask NETMASK          Netmask for "
           "route\n\n");
    printf("  Firewall:\n");
    printf("  -5, --firewall-list            List firewall "
           "rules\n");
    printf("  -6, --firewall-add RULE        Add firewall "
           "rule\n");
    printf("  -7, --firewall-delete RULE     Delete "
           "firewall rule\n");
    printf("  -8, --firewall-flush CHAIN     Flush "
           "firewall chain\n");
    printf("  -9, --chain CHAIN              Firewall "
           "chain\n");
    printf("  --block-ip IP                  Block IP "
           "address\n");
    printf("  --unblock-ip IP                Unblock IP "
           "address\n");
    printf("  --block-port PORT PROTO        Block port\n");
    printf("  --unblock-port PORT PROTO      Unblock "
           "port\n\n");
    printf("  Bandwidth:\n");
    printf("  --bandwidth-test IFACE         Test "
           "bandwidth\n");
    printf("  --bandwidth-monitor IFACE      Monitor "
           "bandwidth\n\n");
    printf("  Monitoring:\n");
    printf("  --monitor-start IFACE          Start network "
           "monitor\n");
    printf("  --monitor-alert IFACE          Monitor with "
           "alerts\n");
    printf("  --threshold MBPS              Alert "
           "threshold\n\n");
    printf("  Discovery:\n");
    printf("  --discovery-ping NETWORK       Ping "
           "discovery\n");
    printf("  --discovery-arp NETWORK       ARP "
           "discovery\n\n");
    printf("  Security:\n");
    printf(
        "  --security-scan HOST           Security scan\n");
    printf("  --security-audit HOST          Security "
           "audit\n");
    printf("  --security-ssl HOST:PORT       SSL security "
           "check\n");
    printf("  --security-ssh HOST:PORT       SSH security "
           "check\n");
    printf("  --security-http HOST:PORT      HTTP security "
           "check\n");
    printf("  --security-smtp HOST:PORT      SMTP security "
           "check\n");
    printf(
        "  --security-banner HOST:PORT    Banner grab\n\n");
    printf("  Extended DNS and Tracing:\n");
    printf("  --dns-server-test SERVER       Test a DNS "
           "server\n");
    printf("  --dns-bruteforce DOMAIN       Brute-force "
           "DNS names from --wordlist\n");
    printf("  --dns-zone-transfer DOMAIN     Attempt an "
           "authorized zone transfer\n");
    printf(
        "  --dnssec-verify DOMAIN         Verify DNSSEC\n");
    printf("  --record-type TYPE             DNS record "
           "type for --dns-query\n");
    printf("  --protocol PROTOCOL            Protocol for "
           "firewall port operations\n");
    printf("  --traceroute-icmp HOST         ICMP "
           "traceroute\n");
    printf("  --ping-udp HOST                UDP ping\n");
    printf("  --ping-sweep NETWORK            Sweep a "
           "network with ICMP\n");
    printf("  --ping-flood HOST              Authorized "
           "ping flood test\n\n");
    printf("  Scan Modes:\n");
    printf("  --network-scan NETWORK         Scan hosts on "
           "a network\n");
    printf(
        "  --udp-scan HOST                UDP port scan\n");
    printf(
        "  --syn-scan HOST                TCP SYN scan\n");
    printf(
        "  --fin-scan HOST                TCP FIN scan\n");
    printf(
        "  --xmas-scan HOST               TCP XMAS scan\n");
    printf(
        "  --null-scan HOST               TCP NULL scan\n");
    printf("  --start-port PORT              First port\n");
    printf(
        "  --end-port PORT                Last port\n\n");
    printf("  Extended System and Network Tools:\n");
    printf("  --netstat-process PID          Connections "
           "owned by a process\n");
    printf("  --netstat-interface IFACE      Interface "
           "network statistics\n");
    printf("  --netstat-group GROUP          Group network "
           "statistics\n");
    printf("  --netstat-timer                Network timer "
           "statistics\n");
    printf("  --route-get DEST               Resolve a "
           "route\n");
    printf("  --route-trace DEST             Trace route "
           "changes\n");
    printf("  --route-monitor                Monitor route "
           "changes\n");
    printf("  --arp-spoof-detect IFACE       Detect ARP "
           "spoofing\n");
    printf("  --arp-request IP               Send an ARP "
           "request\n");
    printf("  --arp-reply IP                 Send an ARP "
           "reply\n");
    printf("  --arp-cache-add IP             Add an ARP "
           "cache entry\n");
    printf("  --arp-cache-delete IP          Delete an ARP "
           "cache entry\n");
    printf("  --interface IFACE              Shared "
           "interface parameter\n");
    printf("  --mac-address MAC              Shared MAC "
           "parameter\n\n");
    printf("  Extended Performance and Discovery:\n");
    printf("  --firewall-status              Show firewall "
           "status\n");
    printf("  --firewall-log 0|1             Disable or "
           "enable firewall logging\n");
    printf("  --bandwidth-speedtest SERVER   Run a "
           "bandwidth speed test\n");
    printf("  --bandwidth-history IFACE      Show "
           "bandwidth history\n");
    printf("  --bandwidth-limit IFACE        Apply a "
           "bandwidth limit\n");
    printf("  --bandwidth-shaper IFACE       Configure "
           "bandwidth shaping\n");
    printf("  --max-bps RATE                 Maximum rate "
           "for bandwidth limit\n");
    printf("  --download-bps RATE            Download "
           "shaping rate\n");
    printf("  --upload-bps RATE              Upload "
           "shaping rate\n");
    printf("  --monitor-stop                 Stop "
           "monitoring\n");
    printf("  --monitor-status               Show monitor "
           "status\n");
    printf("  --monitor-log IFACE            Log interface "
           "monitoring\n");
    printf("  --monitor-export IFACE         Export "
           "interface monitoring\n");
    printf("  --discovery-dns DOMAIN         Discover DNS "
           "hosts\n");
    printf("  --discovery-snmp NETWORK       Discover SNMP "
           "hosts\n");
    printf("  --discovery-upnp NETWORK       Discover UPnP "
           "devices\n");
    printf("  --discovery-mdns NETWORK       Discover mDNS "
           "services\n");
    printf("  --discovery-llmnr NETWORK      Discover "
           "LLMNR hosts\n");
    printf("  --discovery-netbios NETWORK    Discover "
           "NetBIOS hosts\n");
    printf("  --discovery-smb NETWORK        Discover SMB "
           "hosts\n");
    printf("  --discovery-http NETWORK       Discover HTTP "
           "hosts\n");
    printf("  --discovery-ssl NETWORK        Discover SSL "
           "hosts\n\n");
    printf("  Extended Security:\n");
    printf("  --security-dns SERVER          Check DNS "
           "security\n");
    printf("  --security-mitm-detect IFACE   Detect "
           "possible MITM activity\n");
    printf("  --security-port-knocking HOST  Run an "
           "authorized port-knocking test\n");
    printf("  --security-honeypot-detect HOST Detect "
           "honeypot indicators\n");
    printf("  --ports LIST                   "
           "Comma-separated ports for knocking\n");
    printf("  --wordlist FILE                Wordlist for "
           "DNS brute force\n\n");
    printf("  Process Scanning:\n");
    printf("  -N, --scan-processes           Scan network "
           "processes\n");
    printf("  -X, --process NAME             Filter by "
           "process name\n");
    printf("  -I, --pid PID                  Filter by "
           "PID\n\n");
    printf("  Output:\n");
    printf("  -j, --json                     Output in "
           "JSON format\n");
    printf("  -v, --verbose                  Verbose "
           "output\n");
    printf("  -?, --help                     Show this "
           "manual page\n");
    printf("  -w, --version                  Show version "
           "information\n\n");
    printf("EXAMPLES\n");
    printf("  ripnet --list-interfaces\n");
    ...
    printf("  ripnet --scan 192.168.1.1 --start-port 1 "
           "--end-port 1000\n");
    ...
    printf("  1  Command failed, arguments were invalid, "
           "or required resources were unavailable.\n\n");
    printf("RIPNET(1)                 User Commands        "
           "        RIPNET(1)\n");
}
...
int parse_args(int argc, char **argv, cli_args_t *args)
{
    ...
    strncpy(args->protocol,
            "tcp",
            sizeof(args->protocol) - 1);

    while ((opt = getopt_long(
                argc,
                argv,
                "ls:c:f:n:pt:h:P:C:D:R:H:F:S:a:e:T:V:NX:I:"
                "jv?d:r:q:Z:Y:Qg:G:Ui:J:K:M:O:B:ELWA:y:z:o:"
                "1:2:3:4:5:6:7:8:9:!:@:#:$:%:^:&:*():_:+:-:"
                "=:[:]:{:}w",
                long_options,
                &option_index))
           != -1)
    {
        ...
        case 's':
            ...
            strncpy(args->interface,
                    optarg,
                    sizeof(args->interface) - 1);
            break;
        case 'c':
        ...
        case 'f':
            strncpy(args->filter,
                    optarg,
                    sizeof(args->filter) - 1);
            break;
        case 'n':
            if (parse_uint(
                    optarg,
                    (unsigned int *)&args->packet_count)
                < 0)
            {
                fprintf(stderr,
        ...
        case 'C':
            if (parse_uint(
                    optarg,
                    (unsigned int *)&args->concurrency)
                < 0)
            {
                fprintf(stderr,
                        "Invalid concurrency: %s\n",
                        optarg);
                return -1;
            }
            break;
        ...
        case 'R':
            ...
            break;
        case 'H':
            strncpy(args->http_path,
                    optarg,
                    sizeof(args->http_path) - 1);
            break;
        case 'F':
        ...
        case 'a':
            if (parse_uint(
                    optarg,
                    (unsigned int *)&args->start_port)
                < 0)
            {
                fprintf(stderr,
                        "Invalid start port: %s\n",
                        optarg);
                return -1;
            }
            break;
        ...
        case 'N':
            ...
            break;
        case 'X':
            strncpy(args->process_filter,
                    optarg,
                    sizeof(args->process_filter) - 1);
            break;
        case 'I':
            if (parse_uint(
                    optarg,
                    (unsigned int *)&args->pid_filter)
                < 0)
            {
                fprintf(stderr,
                        "Invalid PID: %s\n",
        ...
        case 'd':
            ...
            strncpy(args->hostname,
                    optarg,
                    sizeof(args->hostname) - 1);
            break;
        case 'r':
            args->cmd = CMD_DNS_REVERSE;
            strncpy(args->ip_address,
                    optarg,
                    sizeof(args->ip_address) - 1);
            break;
        case 'q':
            ...
            break;
        case 'Z':
            strncpy(args->dns_server,
                    optarg,
                    sizeof(args->dns_server) - 1);
            break;
        case 'Y':
        ...
        case '2':
            ...
            break;
        case '3':
            strncpy(args->gateway,
                    optarg,
                    sizeof(args->gateway) - 1);
            break;
        case '4':
            strncpy(args->netmask,
                    optarg,
                    sizeof(args->netmask) - 1);
            break;
        case '5':
        ...
        case '7':
                ...
                < 0)
            {
                fprintf(
                    stderr,
                    "Invalid firewall rule number: %s\n",
                    optarg);
                return -1;
            }
            break;
        ...
        case OPT_FIREWALL_LOG:
                ...
                || args->count > 1)
            {
                fprintf(
                    stderr,
                    "Firewall logging expects 0 or 1\n");
                return -1;
            }
            break;
        ...
        case OPT_MAC_ADDRESS:
            strncpy(args->mac_address,
                    optarg,
                    sizeof(args->mac_address) - 1);
            break;
        case OPT_LOG_PATH:
            strncpy(args->log_path,
                    optarg,
                    sizeof(args->log_path) - 1);
            break;
        case OPT_EXPORT_PATH:
            strncpy(args->export_path,
                    optarg,
                    sizeof(args->export_path) - 1);
            break;
        case OPT_WORDLIST:
            strncpy(args->wordlist,
                    optarg,
                    sizeof(args->wordlist) - 1);
            break;
        case OPT_INTERFACE:
            strncpy(args->interface,
                    optarg,
        ...
        case OPT_RECORD_TYPE:
            strncpy(args->record_type,
                    optarg,
                    sizeof(args->record_type) - 1);
            break;
        case OPT_PROTOCOL:
            strncpy(args->protocol,
                    optarg,
